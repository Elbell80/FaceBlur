...
class FaceDetectionAdapter(
    ...
    private val faceDetectionModels: List<FaceDetectionModel>
) : RecyclerView.Adapter<FaceDetectionAdapter.FaceDetectionViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FaceDetectionViewHolder {
        return FaceDetectionViewHolder(
            LayoutInflater.from(context).inflate(R.layout.item_face_detection, parent, false)
        )
    }
